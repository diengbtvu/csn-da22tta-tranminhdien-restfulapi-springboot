                            ...
                            <div class="container-fluid py-4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card dashboard-card bg-primary text-white">
                                            <div class="card-body">
                                                ...
                                                <h2>100</h2>
                                                <p class="mb-0"><i class="fas fa-arrow-up me-2"></i>3.5% so với tháng trước</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card dashboard-card bg-success text-white">
                                            <div class="card-body">
                                                ...
                                                <h2>85</h2>
                                                <p class="mb-0"><i class="fas fa-arrow-up me-2"></i>2.1% so với tháng trước</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card dashboard-card bg-warning text-white">
                                            <div class="card-body">
                                                ...
                                                <h2>520M</h2>
                                                <p class="mb-0"><i class="fas fa-arrow-up me-2"></i>5.2% so với tháng trước</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="card dashboard-card bg-danger text-white">
                                            <div class="card-body">
                                                <h5 class="card-title">Sự cố cần xử lý</h5>
                                                <h2>3</h2>
                                                <p class="mb-0"><i class="fas fa-arrow-down me-2"></i>1.5% so với tháng trước</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                                ...
                                                <div class="list-group">
                                                    <a href="#" class="list-group-item list-group-item-action">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h6 class="mb-1">Ký hợp đồng mới - Căn 1502</h6>
                                                            <small>3 giờ trước</small>
                                                        </div>
                                                        <p class="mb-1">Hợp đồng thuê căn hộ 1502 đã được ký kết với khách hàng Nguyễn Văn A</p>
                                                    </a>
                                                    <a href="#" class="list-group-item list-group-item-action">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h6 class="mb-1">Thanh toán tiền thuê - Căn 1203</h6>
                                                            <small>5 giờ trước</small>
                                                        </div>
                                                        <p class="mb-1">Đã nhận thanh toán tiền thuê tháng 12 từ căn hộ 1203</p>
                                                    </a>
                                                    <a href="#" class="list-group-item list-group-item-action">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h6 class="mb-1">Báo cáo sự cố - Căn 1105</h6>
                                                            <small>1 ngày trước</small>
                                                        </div>
                                                        <p class="mb-1">Báo cáo sự cố về hệ thống điều hòa tại căn 1105</p>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="card-title mb-0">Công việc cần xử lý</h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="list-group">
                                                    <div class="list-group-item">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h6 class="mb-1">Sửa chữa điều hòa - Căn 1105</h6>
                                                            <span class="badge bg-danger">Gấp</span>
                                                        </div>
                                                        <p class="mb-1">Kiểm tra và sửa chữa hệ thống điều hòa</p>
                                                        <small>Deadline: 27/12/2024</small>
                                                    </div>
                                                    <div class="list-group-item">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h6 class="mb-1">Gia hạn hợp đồng - Căn 1502</h6>
                                                            <span class="badge bg-warning">Đang chờ</span>
                                                        </div>
                                                        <p class="mb-1">Chuẩn bị tài liệu gia hạn hợp đồng</p>
                                                        <small>Deadline: 30/12/2024</small>
                                                    </div>
                                                    <div class="list-group-item">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h6 class="mb-1">Kiểm tra PCCC định kỳ</h6>
                                                            <span class="badge bg-info">Định kỳ</span>
                                                        </div>
                                                        <p class="mb-1">Kiểm tra hệ thống PCCC toàn tòa nhà</p>
