                    ...
                    <div class="col-md-12 bg-light">
                        <div class="p-4">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEquipmentModal" id="addEquipmentBtn">
                ...
                <form id="searchForm">
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="searchInput" placeholder="Tên hoặc mã thiết bị...">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-select" id="apartmentFilter">
                                <option value="">Tất cả</option>
                                <option>A101</option>
                                <option>A102</option>
                                <option>A103</option>
                    ...
                    <table class="table table-hover" id="equipmentTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button class="btn btn-sm btn-info me-1" onclick="viewEquipment('EQ001')">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn btn-sm btn-warning me-1" onclick="editEquipment('EQ001')">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger" onclick="deleteEquipment('EQ001')">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <form id="addEquipmentForm">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="warranty" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="saveEquipment()">Lưu</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="editEquipmentModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Same form structure as Add Equipment Modal -->
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
